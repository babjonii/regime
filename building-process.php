        ...
        <div class="w-100 flex-grow-1 ">
            ...
            <div class="">
                <section class="titleSection" id="buildingProcess">
                    <h1 class="page-header text-white">BUILDING YOUR NEW HOME</h1>
                </section>

                <div class="buttonRibbon flex-wrap" id="ribbon">
                    <a href="#step1" class="ribbonButton">STEP 1</a>
                    <a href="#step2" class="ribbonButton ">STEP 2</a>
                    <a href="#step3" class="ribbonButton">STEP 3</a>
                    <a href="#step4" class="ribbonButton ">STEP 4</a>
                    <a href="#step5" class="ribbonButton ">STEP 5</a>
                    <a href="#step6" class="ribbonButton ">STEP 6</a>
                </div>
                <div class="financingMainSection" id="specialProjects">
                    ...
                    <div class="financingMainSection1 flex-wrap align-items-center" id="step5">
                        <div class="col-lg-6 col-md-6 col-sm-12 p-5">
                            <h3><u>FIXTURES, FLOORING AND FINISHES</u></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vel ligula lacinia, pharetra
                                sapien
                                vitae,
                                efficitur
                    ...
                    <div class="sectionDark flex-wrap align-items-center" id="step6">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 p-5 text-white">
                            <h3><u>HOMEOWNER ORIENTATION & WALKTHROUGH</u></h3>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vel ligula lacinia, pharetra
                                sapien
                                vitae,
                                efficitur
                    ...
                    <div class="financingMainSection3 d-flex flex-wrap align-items-center justify-content-center">
                        <p>
                            <strong><a href="contact-us.html">Get in touch</a></strong> with our team or go through our
                            <strong><a href="#">FAQs</a></strong> for further information
                        </p>
                    </div>
